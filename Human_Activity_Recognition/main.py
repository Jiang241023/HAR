...
def main(argv):
    ...
    if FLAGS.train:
        ...
        evaluate(model_1=None, model_2=model_1, ds_test=ds_test, ensemble=False)
        wandb.finish()

    else:
        checkpoint_path_1 = r'E:\DL_LAB_HAPT\HAR\experiments\run_2025-01-11T14-37-59-635246_gru_like\ckpts'
        checkpoint_path_2 = r'E:\DL_LAB_HAPT\HAR\experiments\run_2025-01-11T14-37-59-635246_gru_like\ckpts'
        ...
        evaluate(model_1=model_1, model_2=model_2, ds_test=ds_test, ensemble=True)
        wandb.finish()
